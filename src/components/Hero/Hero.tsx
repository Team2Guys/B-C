    ...
    <Container>
      <section className="border w-full flex">
        <div className="left-side w-1/2 flex flex-col justify-center gap-3">
          ...
          <button className="Upper w-fit bg-white text-14 font-semibold text-black rounded-full px-6  py-1 ">
            SEE ALL
          </button>
        </div>
        <div className="rigt-side w-1/2 relative">
          <div className="cursor-pointer absolute bg-black rounded-full w-9 h-9 text-white p-1 top-[77px] text-10 text-center">
            <span>why us?</span>
          </div>
          <CustomSlider>
