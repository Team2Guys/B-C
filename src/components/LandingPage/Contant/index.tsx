...
const Contant: React.FC<ContantProps> = ({ TabData }) => {
  ...
  return (
    <>
      ...
      <div className="w-full lg:w-1/2 h-full relative top-10 hidden lg:block">
        <video
          ref={videoRef}
          src={TabData.video}
          autoPlay
          ...
          playsInline
          controls={false}
          className="w-full h-[340px] object-cover xl:object-fill"
        />
      ...
      <h2 className='pl-6 lg:pl-0 font-serif font-extrabold text-base sm:text-2xl lg:text-3xl pt-5 lg:pt-10'>
        {TabData.title}</h2>
        ...
        {/* {video for moblie section} */}
        <div className="w-ful h-auto relative  block lg:hidden py-2 px-1">
        <video
          ref={videoRef}
          src={TabData.video}
          autoPlay
