...
const CustomSection: React.FC<CommonSectionProps> = ({ data }) => {
  ...
  return (
    ...
    <Container>
      <div className="flex flex-col md:flex-row gap-8 px-1 xl:px-2 ">
        ...
        <div className="md:w-6/12 xl:w-8/12 space-y-4 md:space-y-3 xl:space-y-6 flex flex-col justify-between ">
        <div>
          <h2 className="text-2xl xl:text-[40px] font-black font-serif leading-8 xl:leading-10 ">{heading}</h2>
          <h2 className="text-2xl xl:text-[36px] font-black font-serif leading-8 xl:leading-10 xl:mt-2">{heading1}</h2></div>
          <p className="lg:text-20 font-normal font-proxima xl:leading-10">{description}</p>
