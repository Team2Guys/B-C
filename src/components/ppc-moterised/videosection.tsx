  ...
  return (
    <div className="mt-3 sm:mt-10 xl:mt-14 bg-white py-5 sm:py-10">
      <Container>
        ...
        <Link href="/request-appointment/" className='px-4 py-2 text-center font-proxima font-medium lg:text-17 text-white bg-black hover:bg-primary rounded-sm hover:opacity-65'>BOOK A FREE CONSULTATION</Link>
