                    ...
                    <div className="rounded-sm border border-stroke bg-white dark:border-strokedark dark:bg-dashboardDark">
                      ...
                      {(posterimageUrl && posterimageUrl?.length > 0) ? (
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 p-4">
                          ...
                          <input className="border mt-2 w-full rounded-md border-stroke px-2 text-14 py-2 focus:border-primary active:border-primary outline-none border-stroke bg-white dark:border-strokedark dark:bg-dashboardDark " placeholder="altText" type="text" name="altText" value={item.altText} onChange={(e) =>
                      ...
                      <FieldArray name="modelDetails">
                        {({ push, remove }) => (
                          <div className="flex flex-col gap-2">
                            {formik.values.modelDetails && formik.values.modelDetails.map(
                              (model: any, index: any) => (
                  ...
                  <div className="rounded-sm border border-stroke bg-white dark:border-strokedark dark:bg-dashboardDark">
                    ...
                    <div className="flex flex-col gap-4 p-4">
                      <FieldArray name="colors">
                        {({ push, remove }) => (
                          <div className="flex flex-col gap-2">
                            {formik.values.colors && formik.values.colors.map(
                              (spec: any, index: any) => (
                                <div key={index} className="flex items-center">
                                  <input
                                    type="text"
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 p-4">
                        {hoverImage.map((item: any, index) => {
                          return (
                            ...
                            <input className="border mt-2 w-full rounded-md border-stroke px-2 text-14 py-2 focus:border-primary active:border-primary outline-none bg-white dark:border-strokedark dark:bg-dashboardDark" placeholder="altText" type="text" name="altText" value={item.altText} onChange={(e) =>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-4">
                        {imagesUrl.map((item: any, index) => {
                          return (
                            ...
                            <input className="border mt-2 w-full rounded-md border-stroke px-2 text-14 py-2 bg-white dark:border-strokedark dark:bg-dashboardDark focus:border-primary active:border-primary outline-none" placeholder="altText" type="text" name="altText" value={item.altText}  onChange={(e) =>
