...
const MyEditor = ({
  ...
  const config = useMemo(
    () => ({
      ...
      toolbar1:
        'undo redo|blocks fontfamily fontsize | styles |restoredraft|nonbreaking| bold italic|accordion|ltr rtl |quickimage|quicktable| importword  ',
      toolbar2:
      ...
      menu: {
        ...
        insert: {
          title: 'Insert',
          items:
            'image link media addcomment pageembed codesample inserttable | upload image |upload | math | charmap emoticons hr | pagebreak nonbreaking anchor tableofcontents | insertdatetime',
        },
        format: {
          title: 'Format',
          items:
