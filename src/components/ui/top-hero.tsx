...
const TopHero: React.FC<TopHeroProps> = ({
  ...
  return (
    <div
      className={`relative      
      flex items-center text-center justify-center bg-no-repeat w-full  border-black h-[200px]  md:h-[55vh] lg:h-[65vh] xl:h-[75vh] 2xl:h-[84vh] bg-center bg-cover xl:bg-custom-size ${className}`}
      style={
        !Video
          ? {
