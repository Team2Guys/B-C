        ...
        <h2 className="lg:text-[39px] md:text-3xl text-2xl font-bold ">
          ...
          <div>
            {data.paragraph.map((para, index) => (
              <p
                key={index}
                className={`text-black text-13 sm:text-14 lg:text-16 font-normal  md:text-justify md:leading-9 md:tracking-wide `}
              >
                {para}
              </p>
            ))}
            ...
            <Link
              ...
              className="bg-primary  text-white px-4 py-4 mt-3 mx-auto md:ms-auto hover:text-black hover:bg-white transition-all  hover:text-dark  w-fit "
            >
