  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 ">
      <div className="bg-white p-6 rounded-lg shadow-lg relative md:h-[550px]">
        ...
        <Image src="https://res.cloudinary.com/de6owjeap/image/upload/v1746275288/laptop_gdsvy2.webp " unoptimized height={500} width={500} objectFit='cover' className='w-full h-full' alt='Banner Image'/>
        </Link>
