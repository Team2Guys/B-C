...
const EstimatorTabs: React.FC<EstimatorTabsProps> = ({
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex bg-[#f6efe9] shadow-md justify-between text-[23px] font-gotham ">
        {filteredCategories.map((category, index) => (
          <div
            key={index}
            onClick={() => handleCategorySelect(index)}
            className={`relative cursor-pointer p-2 px-10 text-center ${
      ...
      <div
        className={`grid  grid-cols-3 xl:grid-cols-4 gap-4 mt-5 max-h-96 overflow-y-auto bg-white  estimator-scrollbar  border-8 border-white `}
