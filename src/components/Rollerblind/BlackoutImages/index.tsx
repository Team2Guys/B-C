...
import { GallaryData1, GallaryData2 } from 'data/data';
...
const groupitems = [
  {
    text: "all",
    images: [...GallaryData1[0].images, ...GallaryData2[0].images]
