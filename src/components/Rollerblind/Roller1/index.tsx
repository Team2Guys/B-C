...
const Rollerpage= () => {
  return (
    ...
    <p className='font-normal md:text-16 lg:text-lg text-center leading-6 max-w-screen-2xl'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type</p>
