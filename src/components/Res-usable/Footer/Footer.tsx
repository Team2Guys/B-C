              ...
              <div className="grid grid-cols-1 sm:grid-cols-2  md:grid-cols-5 gap-5">
                <div className="mb-4 flex flex-col items-center sm:items-start">
                  ...
                  <div className="flex items-center space-x-4 mt-4">
                    ...
                    >
                        <CiFacebook className="w-9 h-9 text-[#F1B42F]" />
                    </Link>
                    <Link
                      target="_blank"
                    ...
                    >
                      <IoLogoPinterest className="w-9 h-9 rounded-full text-[#F1B42F]" />
                    </Link>
                    <Link
                      target="_blank"
                    ...
                    >
                      <AiOutlineInstagram className="w-9 h-9 text-[#F1B42F]" />
                    </Link>
                  </div>
                </div>
                  {isLoading || isError ? (
                              ...
                              items={[
                                {
                                  ...
                                  label: (
                                    <span className="font-semibold text-18 text-black">
                                      {category.title}
                                    </span>
                                  ),
                                  children: (
                                    <ul className="space-y-2 my-4">
                                      {category.title === 'Quick Links' ? (
                                        ...
                                        category.links?.map((link) => (
                                          <li key={link.href}>
                                            <Link
                                              className="text-14 2xl:text-16 text-black font-normal"
                                              href={link.href}
                                            >
                                              {link.text}
                                            </Link>
                ...
                <div className="flex flex-col gap-4 lg:pl-2 mt-0 sm::mt-4 lg:mt-0">
                  ...
                  <div className={`${isMobile ? 'pl-2' : 'pl-0 md:mx-auto'}`}>
                    ...
                    <ul className="space-y-4 mt-4 text-sm lg:w-[100%] ">
                      ...
                      <li className="flex gap-2 flex-nowrap">
                        <SlCalender size={18} className="text-black me-1 ms-[2px]" />
                      ...
                      <li className="flex gap-2 flex-nowrap">
                        <span>
                          <Image
                            ...
                            width={36}
                            height={36}
                            className="min-w-6 w-6 h-6 invert"
                            priority
                            loading='eager'
                          />
                        </span>
