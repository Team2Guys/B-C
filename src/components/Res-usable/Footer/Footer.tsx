...
const Footer: React.FC = () => {
  ...
  return (
    <footer>
      <div className={`bg-white xs:bg-primary-foreground sm:pt-10 sm:pb-5 py-7 ${(pathname.replaceAll('/','') !== 'request-appointment') && (pathname.replaceAll('/','') !== 'estimator') ? 'mt-10' :''}`}>
        <Container>
          <div className="grid grid-cols-1 xs:grid-cols-2  md:grid-cols-4 lg:grid-cols-5 gap-2">
            <div className="mb-4 flex flex-col items-start">
              ...
              <p className="text-sm text-start max-w-64 xs:max-w-56 text-primary font-roboto mt-2 opacity-60">
              ...
              <ul className="space-y-2 mt-2 text-sm lg:w-[100%] text-primary ">
                <li className="flex gap-2 flex-nowrap items-center">
                  ...
                  <Link
                    ...
                    target="_blank"
                    className="text-12 2xl:text-[14px] text-wrap break-all "
                    aria-label='email'
                  >
                    {EmailInfo.email}
                  </Link>
                ...
                <li className="flex gap-2 flex-nowrap items-center">
                  ...
                  <Link
                    ...
                    target="_blank"
                    className="text-12 2xl:text-[14px] text-nowrap"
                  >
                ...
                <li className="flex gap-2 items-center flex-nowrap">
                  ...
                  <p className='text-12 2xl:text-[14px] '>8.30am - 6.00pm 7 days a week</p>
                ...
                <li className="flex gap-2 flex-nowrap">
                  ...
                  <Link
                    target="_blank"
                    className="text-12 2xl:text-[14px] "
                    aria-label="Address"
                    href={
                                ...
                                return (
                                  ...
                                  <React.Fragment key={index}>
                                    {matchingSubcategory && (
                                      <li>
                                        <Link
                                          className="text-12 2xl:text-14 text-[#3E3F42] opacity-60"
                    ...
                    <ul className="text-primary grid grid-cols-1 gap-1 xl:gap-2 mt-2">
                      {locations.map((city) => (
                        <li key={city} className="flex gap-2 flex-nowrap sm:px-0 px-3 ">
                          ...
                          <p className="2xl:text-sm text-12 2xl:text-14 text-[#3E3F42] opacity-60">{city}</p>
                        </li>
                      ))}
                    </ul>
                  </div>
