...
function Header() {
  return (
    ...
    <>
    <Container>
      <header className="flex w-7xl flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white text-sm  ">
                  ...
                  return (
                    <>
                      {dropDown ? (
                        ...
                        <div key={index} className="hs-dropdown [--strategy:static] sm:[--strategy:absolute] [--adaptive:none]   [--is-collapse:true] sm:[--is-collapse:false] ">
