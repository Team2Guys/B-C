...
export const metadata: Metadata = {
  title: 'Automatic Window Curtains | Motorised Curtains | Smart Curtains Dubai',
  description: 'We offer automatic window curtains in Dubai that combine style and convenience. Our motorised curtains offer light control, privacy, and a sleek design.',
  openGraph: {
    title: 'Automatic Window Curtains | Motorised Curtains | Smart Curtains Dubai',
    description: 'We offer automatic window curtains in Dubai that combine style and convenience. Our motorised curtains offer light control, privacy, and a sleek design.',
