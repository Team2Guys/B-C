              ...
              <>
                <div className="relative" key={item.id}>
                  <div className="absolute top-1/2 -left-14 -translate-y-1/2 sm:flex items-center hidden">
                    <div className="border-dashed border border-btnclr w-6"  style={{
            borderImage: "repeating-linear-gradient(90deg, #a9b4a4, #a9b4a4 10px, transparent 10px, transparent 20px) 1",
          }}></div>
