  ...
  return (
    <>
      ...
      <Container className="pt-10 max-w-screen-2xl lg:pb-14 flex justify-between lg:gap-10 items-start flex-col md:flex-row">
        <div className="w-full md:w-1/2 lg:pr-32 px-5">
          ...
          <p className="text-16 xs:text-18 leading-8 mt-4 text-lightdark">
            ...
            to you. When choosing blindsandcurtains.ae for your window
            dressings, you can relax in the knowledge that you’re not only
            buying a beautiful product, but you’re also buying into a customer
            service ethos that will be like no other experience in Dubai. From
            our after-sales care package to our 1 working day guaranteed
            response, you can rest assured that you’ll be in good hands for the
            lifetime of your blinds, curtains or shutters. Great care and pride
            is attached into everything we do. From the blinds we supply and our
            beautiful handmade curtains, to the shutters that we import. You’ll
            have our support from the day they are installed. This is the
      ...
      <Container className="lg:pt-5 pt-8 max-w-screen-2xl lg:pb-14 flex justify-between lg:gap-10 items-start flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 lg:pl-20 px-5 lg:order-2 order-1">
          <h3 className="font-bold text-xl xs:text-2xl tracking-wider">
          ...
          <p className="text-16 xs:text-18 leading-8 mt-4 text-lightdark ">
            ...
            cost-effective method of resolving any issues. When
            choosing blindsandcurtains.ae for your window dressings, you can
            relax in the knowledge that you’re not only buying a beautiful
            product, but you’re also buying into a customer service ethos that
            will be like no other experience in Dubai. From our after-sales care
            package to our 1 working day guaranteed response, you can rest
            assured that you’ll be in good hands for the lifetime of your
