...
const LButton = () => {
  return (
    ...
    <Link className='w-full sm:w-fit text-sm sm:text-17 text-white text-center bg-secondary py-3 px-4 rounded-sm font-medium hover:bg-primary hover:opacity-65 ' href="/request-appointment/">
